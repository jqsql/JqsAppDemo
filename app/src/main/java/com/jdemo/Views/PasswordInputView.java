...
public class PasswordInputView extends AppCompatEditText {
    ...
    //信息回调
    private OnEditTextContentListener mContentListener;
    public interface OnEditTextContentListener{
        void onListen(int size, String content);
    }

    public void setOnEditTextContentListener(OnEditTextContentListener contentListener){
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if(mContentListener!=null)
           mContentListener.onListen(textLength,text.toString());
        invalidate();
    }
