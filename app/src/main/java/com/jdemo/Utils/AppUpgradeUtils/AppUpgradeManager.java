...
import com.jdemo.Beans.SystemVersion;
 ...
 * 版本更新下载工具类
 * 调用方法：
 * AppUpgradeManager.getInstance(MainActivity.this, mSystemVersion).startDown();
 */
public class AppUpgradeManager {
    ...
    private String apkFlag="com.view.provider";//必须和配置文件设置的一致
    //apk下载文件的路径
...
//task.setDestinationUri()
    ...
    private void installApk() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(appContext, apkFlag, apkFile);
