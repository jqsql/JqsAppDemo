...
import com.jdemo.Utils.AppToolUtils;
...
public class BaseItemDecoration extends RecyclerView.ItemDecoration{
    ...
    public BaseItemDecoration(Context context, int leftRight, int topBottom,ManagerType manager) {
        ...
        this.leftRight = AppToolUtils.dip2px(context,leftRight);
        this.topBottom = AppToolUtils.dip2px(context,topBottom);
    }
    public BaseItemDecoration(Context context,ManagerType manager) {
        this.mManagerType=manager;
        this.topBottom = AppToolUtils.dip2px(context,8);
    }
    public BaseItemDecoration(Context context,int space ,ManagerType manager, int size) {
        this.size=size;
        this.mManagerType=manager;
        this.leftRight=this.topBottom = AppToolUtils.dip2px(context,space);
    }
    @Override
